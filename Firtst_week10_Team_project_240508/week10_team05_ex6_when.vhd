...
-- week10
-- week10_team05_ex6_when_else
-- 2학년 2반 2021041089 최태민. 2학년 2반 2021041043 서재권

entity week10_team05_ex6_when is
...
end week10_team05_ex6_when;

architecture Behavioral of week10_team05_ex6_when is
...
--=======================3state buffer 코드============================
	...
	oe2 <= n;
-------------------------Buffer 1-------------------------------------
	c <= a when oe1 = '1' else "ZZZZ";
	
-------------------------Buffer 2-------------------------------------
	c <= b when oe2 = '1' else "ZZZZ";	
--=======================Buffer 코드 설정 끝============================
